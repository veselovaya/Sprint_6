...
class OrderData():
    name_order = ['Антонио', 'Райан']
    lastname_order = ['Бандерас', 'Гослинг']
    address_order = ['Конаковский проезд, 7', 'Югорский проезд, 6']
    phone_order = ['+79991234567', '89111234567']
    comment_order = 'Привезите самый лучший самокат'
    order_1 = [name_order[0], lastname_order[0], address_order[0], phone_order[0], comment_order]
    order_2 = [name_order[1], lastname_order[1], address_order[1], phone_order[1], comment_order]
